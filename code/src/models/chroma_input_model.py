...
#   timestamp: 2025-08-20T08:08:17+00:00
...
class ChromaIntegration(BaseModel):
    ...
    chromaClientPort: Optional[int] = Field(
        None, description='Port argument for Chroma HTTP Client', title='Chroma port'
    )
    chromaClientSsl: Optional[bool] = Field(
        None, description='Enable/Disable SSL', title='Chroma SSL enabled'
    )
    chromaApiToken: Optional[str] = Field(
        None,
        description='Chroma API token for authentication',
        title='Chroma API token',
    )
    chromaTenant: Optional[str] = Field(
        None, description='Chroma tenant ID', title='Chroma tenant'
    )
    chromaDatabase: Optional[str] = Field(
        None, description='Chroma database name', title='Chroma database'
    )
    chromaBatchSize: Optional[int] = Field(
        300,
        description='Number of documents to insert in a single request to Chroma. Default is 300. Lower if you experience timeouts or want finer control.',
        ge=1,
        title='Chroma batch size',
    )
