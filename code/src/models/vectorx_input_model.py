...
#   timestamp: 2024-08-26T19:34:41+00:00
...
class VectorxIntegration(BaseModel):
    vectorxKey: Optional[str] = Field(
        None, description='VectorX key', title='VectorX key'
    )
    vectorxToken: Optional[str] = Field(
        None, description='VectorX token', title='VectorX token'
    )
    vectorxIndexName: Optional[str] = Field(
        None,
        description='Name of the VectorX index where the data will be stored',
        title='VectorX index name',
    )
