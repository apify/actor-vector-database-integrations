...
#   timestamp: 2025-02-24T12:50:53+00:00
...
class PineconeIntegration(BaseModel):
    ...
    pineconeIndexNamespace: Optional[str] = Field(
        None,
        description='Name of the Pinecone index namespace (partition the records in an index)',
        title='Pinecone index namespace',
    )
    ...
    embeddingBatchSize: Optional[int] = Field(
        1000,
        description='Specifies the number of texts to embed in a single batch. Adjusting this setting can help optimize the performance of the embeddings provider. If you encounter errors from the embeddings provider, consider reducing the batch size',
        ge=1,
