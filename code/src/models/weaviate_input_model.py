...
#   timestamp: 2024-07-02T13:21:39+00:00
...
class WeaviateIntegration(BaseModel):
    weaviateUrl: str = Field(
        ...,
        description='REST URL of the Weaviate instance to connect to',
        title='Weaviate URL',
    )
    weaviateApiKey: Optional[str] = Field(
        None, description='Weaviate API KEY', title='Weaviate API KEY'
    )
    weaviateCollectionName: str = Field(
        ...,
